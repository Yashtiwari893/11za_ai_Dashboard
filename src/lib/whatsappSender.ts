...
/**
 * Send an audio/voice message via WhatsApp using 11za.in API
 */
export async function sendWhatsAppAudio(
    ...
    try {
        ...
        if (!audioUrl) {
            return {
                success: false,
                error: "Audio URL is required for voice messages",
            };
        }
        ...
        const payload = {
            ...
            contentType: "audio",
            audioUrl: audioUrl,
            // Additional audio-specific parameters if needed by 11za API
            audioType: "voice", // Indicate this is a voice reply, not music/file
        };

        console.log(`Sending WhatsApp voice message to ${phoneNumber}...`);
        ...
        console.log("WhatsApp voice message sent successfully:", data);
