    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 max-w-6xl">
            <div className="mb-6 sm:mb-8">
                <h1 className="text-2xl sm:text-3xl font-bold mb-2 text-[#0D163F]">Shopify Store Integration</h1>
            ...
            <Tabs defaultValue="setup" className="space-y-4 sm:space-y-6">
                <TabsList className="w-full sm:w-auto">
                    <TabsTrigger value="setup" className="flex-1 sm:flex-none">Setup Store</TabsTrigger>
                    <TabsTrigger value="manage" className="flex-1 sm:flex-none">Manage Stores</TabsTrigger>
                </TabsList>
